...
?>
 <?=form_open('home/create_rep/', $attributes)?>
<section id="main"><article class="width_full"> 
 <header>
      <h3 class="tab_name"><?php echo iconv('TIS-620', 'UTF-8', 'ค้นหารายงานการสร้าง');?></h3>
  ...
  <div class="module_content">
	...
	if(!empty($query)){
	 ...
	 <table class="tableform">
        <thead>
			<tr>        
            <td class="center" width="20%">DocumentLog</td>
            <td class="center" width="20%">DocumentID</td>
			 <td class="center" width="10%">FolderID</td>
            <td class="center" width="15%">DivisionID</td>
			 <td class="center" width="15%">UserID</td>
