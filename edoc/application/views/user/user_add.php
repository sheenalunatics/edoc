...
?>
 <?=form_open('home/user_add/', $attributes)?>
<section id="main"><article class="width_full"> 
 <header>
      <h3 class="tab_name">NEW USER</h3>
  ...
  <div class="module_content">
    <table width="100%" cellspacing="0" class="tableform">
		<tr>
		 ...
		 <tr>
            <td width="20%" class="mandatory">ID</td>
            <td width="80%" class="data"><?=form_input('user_id');?>&nbsp;<?=form_error('user_id');?></font></td>
        </tr> 
		<tr>
             <td width="20%" class="mandatory">Username</td>
            <td width="80%" class="data"><?=form_input('user_name');?>&nbsp;<?=form_error('user_name');?></td>
        </tr>
		<tr>
             <td width="20%" class="mandatory">Password</td>
            <td width="80%" class="data"><?=form_password('user_pass');?>&nbsp;<?=form_error('user_pass');?></td>
        </tr>
		<tr>
            <td width="20%" class="data">First Name</td>
            <td width="80%" class="data"><?=form_input('user_fname');?>&nbsp;<?=form_error('user_fname');?></td>
        </tr>
		<tr>
            <td width="20%" class="data">Last Name</td>
            <td width="80%" class="data"><?=form_input('user_lname');?>&nbsp;<?=form_error('user_lname');?></td>
        </tr>
		<tr>
		<?php 		
				//Setup days
		...
		?>
            ...
            <td width="80%" class="data"><?=form_dropdown('Userdb_Date',$days);?>&nbsp;
										<?=form_dropdown('Usermb_Date',$months);?>&nbsp;										<?=form_dropdown('Useryb_Date',$years);?>&nbsp;
										<?=form_error('Userdb_Date');?>&nbsp;<?=form_error('Usermb_Date');?>&nbsp;<?=form_error('Useryb_Date');?>&nbsp;</td>			
        </tr>
		<tr>
            <td width="20%" class="mandatory">ID Card</td>
            <td width="80%" class="data"><?=form_input('id_card');?>&nbsp;<?=form_error('id_card');?></td>			
        </tr>
		<tr>
            <td width="20%" class="mandatory">Email</td>
            <td width="80%" class="data"><?=form_input('user_email');?>&nbsp;<?=form_error('user_email');?></td>			
        </tr>
		<?php 
			$statuslist = array(
					''  => '-',
		...
		<tr>
            ...
            <td width="80%" class="data"><?=form_dropdown('user_status',$statuslist);?>&nbsp;<?=form_error('user_status');?></td>			
        </tr>
		<tr>
            <td width="20%" class="mandatory">Sex</td>
			
            <td width="80%" class="data"><?=form_dropdown('user_sex',$sexlist);?>&nbsp;<?=form_error('user_sex');?></td>			
        </tr>
		<tr>
            <td width="20%" class="mandatory">Position</td>
            <td width="80%" class="data"><?=form_dropdown('user_position',$positionlist);?>&nbsp;<?=form_error('user_position');?></td>			
        </tr>
