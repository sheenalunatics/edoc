...
/*
function inc_asset_url($asset_name, $module_name = NULL)
{
	return other_asset_url($asset_name, $module_name, 'inc');
}

function inc_asset($asset_name, $module_name = NULL, $attributes = array())
{
	$attribute_str = _parse_asset_html($attributes);

	return include(inc_asset_url($asset_name, $module_name));
}
*/
/*
